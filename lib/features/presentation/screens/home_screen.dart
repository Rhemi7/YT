...
import 'package:youtube_data_api/core/filter_enum.dart';
      ...
      children: [
        ...
        Row(
          ...
          children: [
            FilterWidget(
                text: "Date",
                buttonColor: filterValue == FilterType.date
                    ? Colors.red
                    : Colors.grey,
                onTap: () {
            ...
            FilterWidget(
                text: "Views",
                buttonColor: filterValue == FilterType.views
                    ? Colors.red
                    : Colors.grey,
                onTap: () {
            ...
            FilterWidget(
                text: "Ratings",
                buttonColor: filterValue == FilterType.rating
                    ? Colors.red
                    : Colors.grey,
                onTap: () {
